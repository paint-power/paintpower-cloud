...
;
const metadata = {
    title: 'Paint Power NYC - Professional Painting & Remodeling',
    description: 'Professional painting and interior remodeling company serving New York City since 2007. Quality residential and commercial services.',
    generator: 'paint.app',
    icons: {
        icon: [
            {
